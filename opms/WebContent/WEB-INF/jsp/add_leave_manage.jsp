                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="addleave" method="post" class="form-horizontal adminex-form" id="leave-form" novalidate="novalidate" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-large custom-date-range" data-date="2016-07-07" data-date-format="yyyy-mm-dd">
                                            <input class="form-control dpd1"  id="datetimeStart" placeholder="开始日期"  type="text" name="started">
                                            <span class="input-group-addon">To</span>
                                            <input class="form-control dpd2"  id="datetimeEnd" placeholder="结束日期"  type="text" name="ended">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="days"  class="form-control" placeholder="请输入数字" type="number">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label"><span>*</span>请假事由</label>
                                    <div class="col-sm-10">
                                        <textarea name="reason" placeholder="请假事由，如世界那么大，我想去看看" style="height: 200px;" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <input name="leaveid" id="leaveid"  type="hidden">
